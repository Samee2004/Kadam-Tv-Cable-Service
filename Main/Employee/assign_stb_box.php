                    ...
                    <div class="flex flex-col justify-center h-full">
                        ...
                        <div class="w-full  mx-auto bg-white shadow-lg rounded-sm border border-gray-200">
                            <header class="px-5 py-4 border-b border-gray-100">
                                <h2 class="font-semibold text-gray-800">Assigning Set-top Box Technicain</h2>
                            </header>
                            <div class="p-3">
                                    ...
                                    <table class="table-auto w-full">
                                        <thead class="text-xs font-semibold uppercase text-gray-400 bg-gray-50">
                                            <tr>
                                                ...
                                                <th class="p-2 whitespace-nowrap">
                                                    <div class="font-semibold text-left">Requested Date Time</div>
                                                </th>
                                                <th class="p-2 whitespace-nowrap">
                                        ...
                                        <?php
                                        $get_complaints_query = "SELECT * FROM `installs`,`customer` WHERE `customer`.`cust_email` = `installs`.`cust_email`";
                                            ...
                                            <tr>
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class="">
                                                        ...
                                                        <div class="font-normal text-gray-500"><?php echo $row["cust_email"] ?></div>
                                                    </div>
                                                </td>
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class="text-left"> <?php echo $row["installs_req_date"] ?></div>
                                                    <div class="text-left"> <?php echo $row["installs_req_time"] ?></div>
                                                </td>
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class="text-left"> <?php echo $row["cust_flat"] ?> <?php echo $row["cust_building"] ?> </div>
                                                    <div class="text-left"> <?php echo $row["cust_street"] ?></div>
                                                    <div class="text-left"> <?php echo $row["cust_phone"] ?></div>

                                                </td>
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class="text-left font-medium "><b><?php echo $row["installs_status"] ?></b> </div>
                                                    <div class="text-left ">
                                                        <?php
                                                            $employee_id = $row["emp_email"];
                                                ...
                                                <td class="p-2 whitespace-nowrap">
                                                    <div class="text-center">
                                                        <a href="#" type="button" onclick='OpenModal(<?php echo $row["installs_id"] ?>)' data-modal-target="editUserModal" data-modal-toggle="editUserModal" class="openModel font-medium text-blue-600 dark:text-blue-500 hover:underline">
                                                        Action
                                                        </a>
                                                    </div>
                                                </td>
                            ...
                            <div class="p-6 space-y-6">
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-12 sm:col-span-12">
                                        ...
                                        <label for="technican_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Technicain</label>
                                        <select id="technican_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <option selected hidden value="">Choose a Technican</option>
                                            <?php
                                    ...
                                    <div class="col-span-12 sm:col-span-12">
                                        <label for="technican_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Set-top box</label>
                                        <select id="stb_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                            <option selected hidden >Choose Set-top box</option>
                                            <?php
                                                $get_stb = "SELECT * FROM `settopbox` WHERE stb_status = 'Available' ";
                                                $excecute_get_stb_query = mysqli_query($con,$get_stb);
                                                if(mysqli_num_rows($excecute_get_stb_query)>0)
                                                {
                                                    while ($row_of_stb=mysqli_fetch_assoc($excecute_get_stb_query)) {
                                                                                                                ?>
                                                        <option value="<?php echo($row_of_stb["stb_number"]); ?>"> <?php echo($row_of_stb["stb_number"]); ?> </option>
                                                        <?php 
                                                    }
                                                }
                                            ?>
                                        ...
                                        <p id="stb-id-error" class="text-red-500"></p>
                                    </div>
                                </div>
                            </div>
                            <!-- Modal footer -->
