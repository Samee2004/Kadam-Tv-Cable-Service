                  ...
                  ?>
                      <div class="p-4 sm:w-1/2 lg:w-1/3 w-full hover:scale-105 duration-500 channel_name">
                          ...
                          <div>
                              ...
                              $subscribed= "SELECT * FROM `subscription`,`subscribeforchannel` WHERE sub_cust_id='$email' AND `subscribeforchannel`.`subchan_id`=`subscription`.`sub_id` AND `subscribeforchannel`.`channel_id`= '$chan_id' AND `subscription`.`sub_end_date`> '$currentDate' ";
                                  ...
                                  <?php
                                          ...
                                          if(mysqli_num_rows($execute_custcheckstb)==1)
                                          {
                                            ...
                                            <?php
                                              ...
                                              ?>
                                  class="text-sm mt-6 px-4 py-2 bg-black text-white rounded-lg  tracking-wider hover:bg-yellow-600 outline-none">
