      ...
      >
        ...
        <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
          ...
          >
            <!-- Mobile hamburger -->
            <button
              class="p-1 -ml-1 mr-5 rounded-md focus:outline-none focus:shadow-outline-purple block lg:hidden"
            ...
            <div class="py-4 text-gray-500 dark:text-gray-400 hidden lg:block">
              <a
                class="ml-6 text-lg font-bold text-gray-800 dark:text-gray-200"
                href="#"
              >
