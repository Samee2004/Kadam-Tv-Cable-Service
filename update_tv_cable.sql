...
--
-- Host: localhost
-- Generation Time: Feb 20, 2024 at 09:06 PM
...
(1, '2024-02-07', '2024-02-17', 'hrushiop9988@gmail.com'),
...
--
ALTER TABLE `subscribeforchannel`
  ADD CONSTRAINT `subscribeforchannel_ibfk_1` FOREIGN KEY (`subchan_id`) REFERENCES `subscription` (`sub_id`),
...
--
ALTER TABLE `subscribeforpackage`
  ADD CONSTRAINT `subscribeforpackage_ibfk_1` FOREIGN KEY (`subpack_id`) REFERENCES `subscription` (`sub_id`),
...
--
ALTER TABLE `subscription`
  ADD CONSTRAINT `subscription_ibfk_1` FOREIGN KEY (`sub_cust_id`) REFERENCES `Customer` (`cust_email`);
COMMIT;
